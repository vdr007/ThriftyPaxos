...
public class ParameterRemote implements ParameterInterface {
     ...
     */
    public void readMetaData(ByteBuffer bb) throws IOException {
        dataType = bb.getInt();
     ...
     */
    public static void writeMetaData(ByteBuffer bb, ParameterInterface p)
            throws IOException {
        bb.putInt(p.getType());
        bb.putLong(p.getPrecision());
        bb.putInt(p.getScale());
        bb.putInt(p.getNullable());
    }
